            ...
            while(0!=1):
                ...
                for x in range(len(self.tree.currentNode.data.applyMove(self.tree.currentNode.data.move()))):
                    ...
                    if (self.checkIn(self.tree.currentNode.data.applyMove(self.tree.currentNode.data.move())[x]))==False:
                        ...
                        if self.heuristic(self.tree.currentNode.data.applyMove(self.tree.currentNode.data.move())[x])<=heuristic:
...
def main():
    ...
    solver=PuzzleSolver(np.array(['1','2','3','4','_','6','7','5','8']),np.array(['1','2','3','4','5','6','7','8','_']))
