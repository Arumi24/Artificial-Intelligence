...
class HeuristicPlayer(Player):
    ...
    def Statistics(self,Board):
        ...
        print("Right Diagonal: {}      Right Diagonal: {}".format(self.rightDiagonal(Board.board,"Red"),self.rightDiagonal(Board.board,"Yellow")))
        print("Left Diagonal: {}       Left Diagonal: {}".format(self.leftDiagonal(Board.board,"Red"),self.leftDiagonal(Board.board,"Yellow")))
        print("Horizontal: {}          Horizontal: {}".format(self.horizontal(Board.board,"Red"),self.horizontal(Board.board,"Yellow")))
        print("Vertical: {}            Vertical: {}".format(self.vertical(Board.board,"Red"),self.vertical(Board.board,"Yellow")))
...
class AlphaBetaPlayer(HeuristicPlayer):
    ...
    def pickMove(self,Board,turn):
        ...
        if turn=="Yellow":
            move=self.minimax(Board,8,"Yellow",alpha=float("-inf"),beta=float("inf"))[0]
            Board.putYellow(move)

        else:
            move=self.minimax(Board,8,"Red",alpha=float("-inf"),beta=float("inf"))[0]
            Board.putRed(move)
    ...
    def minimax(self,Boardd,depth,turn,alpha,beta):
        ...
        if turn=="Red":
            ...
            for i in moves:
                ...
                simulatedBoard=Board(copy=True,board=self.simulateRedMove(Boardd,i))
                evaluation=self.minimax(simulatedBoard,depth-1,"Yellow",alpha,beta)[1]
            ...
            for i in moves:
                ...
                simulatedBoard=Board(copy=True,board=self.simulateYellowMove(Boardd,i))

                evaluation=self.minimax(simulatedBoard,depth-1,"Red",alpha,beta)[1]
...
class Game(object):
    ...
    def RandomVsAlphaBeta(self):
        ...
        while turn <= 44:
            ...
            if(turn % 2 == 0 and turn < 44):
                ...
                print("\x1b[31mRed Turn:\x1b[0m")
                print("Please pick available moves")
                print(alphaPlayer.availableMoves(board))
                print("")
                ...
                print("\x1b[33mYellow Turn:\x1b[0m")
                print("Please pick available moves")
                print(randomPlayer.availableMoves(board))
                print("")
                time.sleep(0.5)
    ...
    def PlayGame(self):
        ...
        while True:
            ...
            print("6: RandomPlayer Vs RandomPlayer")
            print("7: RandomPlayer Vs Alpha Beta Player")
            print("8: Alpha Beta Player Vs Alpha Beta Player")
